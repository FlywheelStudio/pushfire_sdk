...
class PushFireSDKImpl {
  ...
  final _subscriberLoggedInController = StreamController<Subscriber>.broadcast();
  ...
  Future<void> _initialize(PushFireConfig config) async {
    ...
    try {
      ...
      PushFireLogger.info('Firebase already initialized or initialization failed: $e');
    }
  ...
  Stream<Subscriber> get onSubscriberLoggedIn => _subscriberLoggedInController.stream;
  
  /// Stream of subscriber logout events
  Stream<void> get onSubscriberLoggedOut => _subscriberLoggedOutController.stream;
