...
class PushFireSDK {
  ...
  Stream<Device> get onDeviceRegistered => PushFireSDKImpl.instance.onDeviceRegistered;
  
  /// Stream of subscriber login events
  /// 
  /// Emits [Subscriber] when subscriber logs in
  Stream<Subscriber> get onSubscriberLoggedIn => PushFireSDKImpl.instance.onSubscriberLoggedIn;
  
  /// Stream of subscriber logout events
  /// 
  /// Emits when subscriber logs out
  Stream<void> get onSubscriberLoggedOut => PushFireSDKImpl.instance.onSubscriberLoggedOut;
  
  /// Stream of FCM token refresh events
  /// 
  /// Emits new FCM token when it's refreshed
  Stream<String> get onFcmTokenRefresh => PushFireSDKImpl.instance.onFcmTokenRefresh;
